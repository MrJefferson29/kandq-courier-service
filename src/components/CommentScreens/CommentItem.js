...
const CommentItem = ({ comment, activeUser }) => {
    ...
    useEffect(() => {
        ...
        const getCommentLikeStatus = async () => {
            ...
            try {
                const { data } = await axios.post(`https://delivery-wheat.vercel.app/comment/${comment_id}/getCommentLikeStatus`, { activeUser },
    ...
    const handleCommentLike = async () => {
        ...
        try {
            const { data } = await axios.post(`https://delivery-wheat.vercel.app/comment/${comment_id}/like`, { activeUser }, {
                headers: {
                    "Content-Type": "application/json",
                    authorization: `Bearer ${localStorage.getItem("authToken")}`,
                },
